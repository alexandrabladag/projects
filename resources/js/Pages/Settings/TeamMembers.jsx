        ...
        <AppLayout title="Team Members" breadcrumbs={[{ label: 'Settings' }, { label: 'Team Members' }]}>
            ...
            <div className="max-w-3xl">
                <div className="flex items-center justify-between mb-6">
                    <p className="text-[13px] text-[#6b7280]">Your company employees who can be assigned as project leads. Everyone with manage access is listed here.</p>
                        ...
                        {accounts.map(a => (
                            <div key={`acct-${a.id}`} className="flex items-center gap-4 px-5 py-4 border-b border-[#f0f0f0] last:border-b-0 hover:bg-[#fafbfc] transition-colors">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="text-[11px] text-[#9ca3af] mt-0.5">{a.email}</div>
                                    <div className="text-[11px] text-emerald-600 mt-0.5 inline-flex items-center gap-1">
                                        <LinkIcon size={11} /> Has login access
                                    </div>
                                </div>
                                <button onClick={() => openFromAccount(a)} className="inline-flex items-center gap-1.5 text-[12px] text-[#6b7280] hover:text-[#4f6df5] border border-[#d1d5db] hover:border-[#4f6df5] rounded-lg px-3 py-1.5 transition-colors">
