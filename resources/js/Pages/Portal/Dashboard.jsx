                        ...
                        >
                            <div className="flex items-start justify-between mb-3">
                                <div>
                                    ...
                                    <div className="text-[12px] text-[#4b5563] mt-0.5">{p.phase} · Started {fmtDate(p.start_date)}</div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Badge status={p.status} />
                                    <ArrowRight size={16} className="text-[#6b7280] group-hover:text-[#4f6df5] transition-colors" />
                                </div>
                            </div>
